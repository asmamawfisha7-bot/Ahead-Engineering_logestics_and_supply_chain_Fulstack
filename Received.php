...
<form action="Received.php" method="post" name="delete" onsubmit="return checkvalidation()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View Receiving Profile   </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
$result = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='received'");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='received'");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='received'");
...
while($row = mysqli_fetch_array($result))
  {
                  echo '<tr width:100px;><form action="Received.php " method="post" >';
				    echo "<td><input style='width:150px;' value='".$row[0]."' name=date readonly id=eid> </td>";
                    echo "<td><input style='width:150px;' value='".$row[1]."' name=documentno readonly id=eid> </td>";
