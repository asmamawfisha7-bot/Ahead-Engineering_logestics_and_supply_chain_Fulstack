...
<form action="ViewTransferProfile.php" method="post" name="delete" onsubmit="return checkvalidation()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View Transfer profile  </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
$result = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM transfer");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM transfer");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,productname,producttype,unit,quantity,status,store FROM transfer");
...
while($row = mysqli_fetch_array($result))
  {
                    echo '<tr width:100px;><form action="ViewTransferProfile.php " method="post" >';
