...
$result = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseris' order by producttype");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseris' order by producttype");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseris' order by producttype");
