...
<form action="TransferAc.php " method="POST" name="" onsubmit="return checkvalidation()">
<fieldset><legend align="center" font="white"> <font face='calibri' size='5px' color="brown"> Transfer Accesseries Registration Form </font></legend>&nbsp;<br><br>
<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
<label id="">Date:</label>
 ...
 <label id="">Status:</label>
    <select input style="height:25px;width:300px;" required id="status" name="status" >
    <option input style="height:25px;width:300px;" value="">select</option> 
    ...
    <label id="">Store:</label>
	 ...
	 <option  value="hayahulet">hayahulet</option>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
       <input type="submit" value="Submit" Onclick='return ConfirmTransfer();' name="submit" id="submit" height="100px" width="50px">&nbsp;&nbsp;&nbsp;
	...
	if(isset($_POST['submit']))
{
		...
		$quantity=$_POST['quantity'];
            $status=$_POST['status'];
		$store=$_POST['store'];
		$res=mysqli_query($data, "INSERT INTO transfer values('$date','$productid','$generalname','$productname','$producttype','$unit',
		'$quantity','$status','$store')");
		if(!$res)
	{
      echo"<script>alert('Insertion Failled!!!')</script>";;
	}
	else
	{
      echo"<script>alert('Succesfully Insererted!!!')</script>";
	}
