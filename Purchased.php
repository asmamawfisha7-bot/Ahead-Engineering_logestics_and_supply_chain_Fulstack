...
<form action="purchased.php" method="post" name="view" onsubmit="return checkvalidation()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View Purchased profile   </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
$result = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,documentno,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
...
echo"<td><font color='black'>Document No</font></td>";
...
while($row = mysqli_fetch_array($result))
  {
                  echo '<tr width:100px;><form action="Purchased.php " method="post" >';
				    echo "<td><input style='width:100px;' value='".$row[0]."' name=date readonly id=eid> </td>";
                    echo "<td><input style='width:120px;' value='".$row[1]."' name=documentno readonly id=eid> </td>";
					echo "<td><input style='width:100px;' value='".$row[2]."' name=productid readonly id=eid> </td>";
					...
					echo "<td><input style='width:80px;' value='".$row[8]."' name=store readonly id=eid> </td>";
