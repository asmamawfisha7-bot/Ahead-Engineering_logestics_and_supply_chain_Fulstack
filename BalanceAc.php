...
<form action="BalanceAc.php " method="POST" name="" onsubmit="return checkvalidation()">
<fieldset><legend align="center" font="white"> <font face='calibri' size='5px' color="brown">Accesseries Balance Registration form</font></legend>&nbsp;<br><br>
<center>
   &nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	if(isset($_POST['submit']))
{
	...
	{
    echo"<script>alert('Insertion Succesfully!!!')</script>";
	}
