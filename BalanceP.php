...
<form action="ViewBalanceProfile.php" method="post" name="delete" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View All Profile Balances </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
...
store FROM balancep where generalname='Profile'");
...
echo"<td><font color='black'>Genral Name</font></td>";
...
while($row = mysqli_fetch_array($result))
  {
          echo '<tr width:100px;><form action="BalanceP.php " method="post" >';
				  echo "<td><input style='width:100px;' value='".$row[0]."' name=date readonly  id=date> </td>";
					...
					echo "<td><input style='width:120px;' value='".$row[4]."' name=producttype readonly pattern='[A-Za-z]{3,15}' title='please fill InputType letter only' > </td>";
					...
					echo "<td><input style='width:130px;' value='".$row[6]."' name=deliveredquantity pattern='[0-9]{1,10}' title='please fill Withdraw Number only' > </td>";
