...
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View All Stock In Profiles </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
$result = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM stockin");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM stockin");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM stockin");
...
while($row = mysqli_fetch_array($result))
  {
                    ...
                    echo "<td><input style='width:120px;' value='".$row[4]."' name=producttype readonly id=eid> </td>";
                    echo "<td><input style='width:100px;' value='".$row[5]."' name=unit readonly id=eid> </td>";
