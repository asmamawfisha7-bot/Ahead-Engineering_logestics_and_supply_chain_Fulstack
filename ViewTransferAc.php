...
<body bgcolor="#ffff66">
<tr >
<td><img src="image/logo.png" width="300" height="150" align='left'></td>
</tr> 
 <div class="header">
...
<form action="ViewTransferAc.php" method="post" name="view" onsubmit="return checkvalidation()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$result = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM transfer where unit='pcs' order by date DESC");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM transfer where unit='pcs' order by date DESC");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,quantity,status,store FROM transfer where unit='pcs' order by date DESC");
...
while($row = mysqli_fetch_array($result))
  {
          echo '<tr width:100px;><form action="ViewTransferAc.php " method="post" >';
					...
					echo "<td><input style='width:90px;' value='".$row[2]."' name=generalname readonly id=pid> </td>";
