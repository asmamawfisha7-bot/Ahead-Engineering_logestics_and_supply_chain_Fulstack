...
<form action="UpdateTransferAc.php" method="post" name="update" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">Change Accesseries Transfer Page</font></legend> <br><br>
<?php 
include ('Conn.php');
if (isset($_POST['UpdateTransferAc'])) {
...
$select_query = "SELECT  * FROM transfer"; 
     ...
     while($row = mysqli_fetch_row($select_result)) {
        echo '<tr width:200px;><form action="UpdateTransferAc.php" method="post" >';
       ...
       echo "<td><input name='UpdateTransferAc' type=submit value='update' Onclick='return ConfirmUpdate();'> </td></form></tr>";
	              }
				echo "</table>"; 
