...
<body bgcolor="#ffff66">
 <div class="header">
	<h2>WELCOME TO AHEAD ENGINEERING PLC. HOME PAGE</h2>
 </div>
...
<tr><td colspan=3>
 ...
 <li> <a href="Profile.php" class="active">Profiles</a></li>
 <li> <a href="Accesseries.php" class="active">Accesseries</a></li>
 <li> <a href="location.php" class="active">Store</a>
...
<td bgcolor="white"><h2>
<marquee behavior="right" bgcolor='black' style="color: white;">Welcome To Ahead Engineering Stock Management System phone:0961787878 and 0951787878 call with us </marquee></h2></center></font>
