...
<form action="purchasedAc.php" method="post" name="view" onsubmit="return checkvalidation()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View Purchased Accesseries   </font></legend> <br><br>
 <center>&nbsp;&nbsp;&nbsp;
<?php
include('Conn.php');
$result = mysqli_query($data, "SELECT date,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,productname,producttype,unit,quantity,status,store FROM stockin where status='purchased'");
...
while($row = mysqli_fetch_array($result))
  {
                  echo '<tr width:100px;><form action="PurchasedAc.php " method="post" >';
					...
					echo "<td><input style='width:80px;' value='".$row[7]."' name=store readonly id=eid> </td>";
