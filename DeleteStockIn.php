...
<form action="DeleteStockIn.php" method="post" name="delete" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">Deleting Balance Page</font></legend> <br><br>
<?php 
include ('Conn.php');
     $select_query = "select * from stockin order by date DESC"; 
         if (isset($_POST['DeleteStockIn'])) {
	          $productid=$_POST['productid'];
		        $delete_query = "delete from stockin where productid = '$productid'";
    ...
    echo"<td><font color='red'>Quantity</font></td>";
     ...
     while($row = mysqli_fetch_row($select_result)) {
					echo '<tr><form action="DeleteStockIn.php" method="post">';
					echo "<td><input style='width:100px;' value='".$row[0]."' name=date readonly> </td>";
					echo "<td><input style='width:100px;' value='".$row[1]."' name=productid readonly> </td>";
          echo "<td><input style='width:100px;' value='".$row[2]."' name=generalname readonly> </td>";
					...
					echo "<td><input type=submit name='DeleteStockIn' value='Delete' Onclick='return ConfirmDelete();'> </td></form></tr>";
	              }
