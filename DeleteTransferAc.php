...
<form action="DeleteTransferAc.php" method="post" name="delete" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">Deleting Transfer Accesseries Page</font></legend> <br><br>
<?php 
include ('Conn.php');
     $select_query = "select * from transfer order by date DESC"; 
         if (isset($_POST['DeleteTransferAc'])) {
    ...
    echo "<table id='qq' style='width:1000px;border:1px solid #336699;border-radius:10px;' align='center'><font color=white>";
     ...
     while($row = mysqli_fetch_row($select_result)) {
        echo '<tr width:200px;><form action="DeleteTransferAc.php" method="post" >';
		...
		echo "<td><input type=submit name='DeleteTransferAc' value='Delete' Onclick='return ConfirmDelete();'> </td></form></tr>";
	              }
