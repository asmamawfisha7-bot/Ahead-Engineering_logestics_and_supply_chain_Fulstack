...
<form action="ViewBalanceAc.php" method="post" name="delete" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">View Accesseries Balances</font></legend> <br><br>
  
<?php
include('Conn.php');

$result = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseries' order by producttype");
$d=mysqli_num_rows($result);
$result2 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseries' order by producttype");
$f=mysqli_num_rows($result2);
$result3 = mysqli_query($data, "SELECT date,productid,generalname,productname,producttype,unit,deliveredquantity,balancequantity,store FROM balancep where generalname='Accesseries' order by producttype");
...
while($row = mysqli_fetch_array($result))
  {
          echo '<tr width:100px;><form action="BalanceAcc.php " method="post" >';
