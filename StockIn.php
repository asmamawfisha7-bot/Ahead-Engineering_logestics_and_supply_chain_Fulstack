...
<script>
  ...
  {
    var x = confirm("Do You Want to Insert?");
    if (x)
        return true;
    else
      return false;
...
<form action="StockIn.php" method="post" name="delete" onsubmit="return checkvalidation()">
<fieldset id=""><legend align="center"> <font face='calibri' size='5px' color="brown">Stock In Registration Form  </font></legend> <br><br>
<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;<label id="">Date:</label>
 ...
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	<label id="">Store:</label>
	 ...
	 <option  value="hayahulet">hayahulet</option>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
       <input type="submit" Onclick='return ConfirmStockIn();' name="submit" id="submit" height="100px" width="50px">&nbsp;&nbsp;&nbsp;
...
{       
   $date=$_POST['date'];
    ...
    $generalname=$_POST['generalname'];
		...
		$status=$_POST['status'];
		$store=$_POST['store'];
		$res=mysqli_query($data, "INSERT INTO stockin values('$date','$productid','$generalname','$productname','$producttype','$unit',
