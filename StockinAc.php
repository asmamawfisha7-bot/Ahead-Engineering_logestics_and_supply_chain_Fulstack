...
<form action="StockInAc.php" method="POST" name="" onsubmit="return checkvalidation()">
<fieldset><legend align="center" font="white"> <font face='calibri' size='5px' color="brown">Accesseries StockIn Registration Form </font></legend>&nbsp;<br><br>
<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <label id="">Date:</label>
    <input type="datetime-local" style="height:25px;width:300px;" name="date" required id="eid"><br><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <label id="">Status:</label>
    <select input style="height:25px;width:300px;" required id="producttype" name="status" >
    <option input style="height:25px;width:300px;" value="">select</option> 
